        ...
        <div className="flex-col flex">
          <div className="w-full border-b-2 border-gray-200">
            <div className="h-16 justify-between items-center mx-auto px-4 flex">
              <div>
                <h1 className="text-gray-900 font-extrabold">Dashboard</h1>
              </div>
              <div className="lg:block ml-auto hidden relative max-w-xs">
                <p className="pl-3 items-center flex absolute inset-y-0 right-3 pointer-events-none">
              ...
              <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                ...
                <div className="justify-center items-center flex relative text-gray-900">
                  <img
                  ...
                  <Link to="/login" className="font-semibold text-sm">
                    {" "}
                    <button
                      class="rounded-full border-black"
                      onClick={userLogout}
                    >
                      Logout
                    </button>
